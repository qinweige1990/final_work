...
class Config:
    ...
    def __init__(self, search_keywords="", file_lengths=100, image_quality="orig", bookmarks="", download_nums=10):
        self.search_keywords = search_keywords
        self.file_lengths = file_lengths
        self.image_quality = image_quality
        self.bookmarks = bookmarks
        self.download_nums = download_nums

    @property
    def download_num(self):
        return self.download_num
    @download_num.setter
    def download_num(self, download_nums):
        self.download_nums = download_nums
